...
const Schema: z.ZodType<Prisma.ConsumptionUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ConsumptionUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
