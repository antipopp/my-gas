...
import { ConsumptionUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from "./ConsumptionUncheckedUpdateManyWithoutUserNestedInput.schema";
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSessionsInput> = z
  .object({
    ...
    consumptions: z
      .lazy(
        () => ConsumptionUncheckedUpdateManyWithoutUserNestedInputObjectSchema
      )
      .optional(),
    accounts: z
