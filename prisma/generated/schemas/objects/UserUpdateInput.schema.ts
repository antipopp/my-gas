...
import { ConsumptionUpdateManyWithoutUserNestedInputObjectSchema } from "./ConsumptionUpdateManyWithoutUserNestedInput.schema";
...
const Schema: z.ZodType<Prisma.UserUpdateInput> = z
  .object({
    ...
    image: z
      ...
      .nullable(),
    consumptions: z
      .lazy(() => ConsumptionUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    accounts: z
